...
import { DangerZoneRenderer } from '@game/rendering/danger-zone-renderer';
import { EffectSpawner } from '@game/rendering/effect-spawner';
import { clearDynamicLayers, createGameSceneLayers, GameSceneLayers } from '@game/rendering/game-scene-layers';
import { GameHudRenderer } from '@game/rendering/hud/game-hud-renderer';
...
import { findAliveSpectatorTarget, SpectatorDirection } from '@game/spectator/spectator-follow';
import { shouldUseSpectatorMode } from '@game/spectator/spectator-mode';
import { TouchControls } from '@game/input/touch-controls';
import { environment } from '@env/environment';
import type {
  PlayerEliminatedEvent,
  ViewerCountChangedEvent,
} from '@game/rendering/hud/match-notification.types';
