...
} from '@game/rendering/textures/tank-svg-textures';
import { ensureWeaponOverlayTexture } from '@game/rendering/textures/weapon-svg-textures';
import { ensureShieldSvgTexture } from '@game/rendering/textures/shield-svg-textures';
import { ensureTankTrackSvgTextures } from '@game/rendering/textures/tank-track-svg-textures';
import {
