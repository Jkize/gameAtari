...
import { GAME_VIEW_HEIGHT, HUD_HEIGHT } from '@game/config/viewport.config';
...
import { EliminationFeedRenderer } from '@game/rendering/hud/elimination-feed-renderer';
import { countAlivePlayers, MatchStatusPanel } from '@game/rendering/hud/match-status-panel';
import type { PlayerEliminatedEvent } from '@game/rendering/hud/match-notification.types';
