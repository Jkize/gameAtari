...
import { GAME_VIEW_HEIGHT, GAME_VIEW_WIDTH } from '@game/config/viewport.config';
...
import {
  ...
  GameSceneLayers,
} from '@game/rendering/game-scene-layers';
import { PlayerRenderer } from '@game/rendering/player-renderer';
import { TouchControlHighlight, TouchControls } from '@game/input/touch-controls';
import { ensureShieldSvgTexture } from '@game/rendering/textures/shield-svg-textures';
import { ensureTankSvgTextures } from '@game/rendering/textures/tank-svg-textures';
import { BulletPublicState, EBulletKind, GameMap, PlayerPublicState } from '@game/contracts/game-state.types';
...
export class TutorialScene extends Phaser.Scene {
  ...
  preload(): void {
    const assets = [
      ['tutorial-bush', 'assets/game/obstacle/bush/bush_02_irregular_leafy.svg'],
      ['tutorial-flowers', 'assets/game/obstacle/decoration/decoration_03_pink_yellow_flowers.svg'],
      ['tutorial-rock', 'assets/game/obstacle/rock_block_1.svg'],
      ['hud-shot', 'assets/game/power/shot.svg'],
      ['hud-dash', 'assets/game/power/dash.svg'],
      ['hud-shield', 'assets/game/power/shield.svg'],
    ] as const;
    assets.forEach(([key, path]) => this.load.svg(key, path, { width: 64, height: 64 }));
    this.load.audio('weapon-standard-fire', [
      'assets/game/sounds/effects/weapon_standard_fire.ogg',
      'assets/game/sounds/effects/weapon_standard_fire.mp3',
    ]);
    this.load.audio('player-dash', [
      'assets/game/sounds/effects/dash.ogg',
      'assets/game/sounds/effects/dash.mp3',
    ]);
    this.load.audio('bullet-hit-spark', [
      'assets/game/sounds/effects/bullet_hit_spark.ogg',
      'assets/game/sounds/effects/bullet_hit_spark.mp3',
    ]);
  }
