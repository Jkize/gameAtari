...
export const PHASER_GAME_ASSETS: readonly PhaserGameAsset[] = [
  ...[
    ...
    path: `assets/game/obstacle/bush/${assetId}.svg`,
  ...
  ...[
    ...
    type: 'svg' as const,
    key: `obstacle-${assetId}`,
    path: `assets/game/obstacle/decoration/${assetId}.svg`,
    textureSize: OBSTACLE_SIZE,
  })),
  ...[
    'wood_barricade_1',
    ...
    type: 'svg' as const,
    key: `obstacle-${assetId}`,
    path: `assets/game/obstacle/${assetId}.svg`,
    textureSize: OBSTACLE_SIZE,
  })),
  {
    type: 'image',
    key: 'obstacle-steel_block_01',
    path: 'assets/game/obstacle/steel_block_01.png',
  },
  {
    type: 'svg',
    key: 'obstacle-mirror_panel_01',
    path: 'assets/game/obstacle/mirror_panel_01.svg',
    textureSize: MIRROR_SIZE,
  },
  ...['triple_shot', 'shotgun', 'grenade', 'laser'].map((type) => ({
    type: 'svg' as const,
    key: `weapon-power_${type}`,
    path: `assets/game/weapon/power_${type}.svg`,
    textureSize: WEAPON_SIZE,
  })),
  ...['dash', 'shot', 'shield'].map((type) => ({
    type: 'svg' as const,
    key: `hud-${type}`,
    path: `assets/game/power/${type}.svg`,
    textureSize: HUD_ICON_SIZE,
  })),
  {
    type: 'svg',
    key: 'hud-bottom-panel',
    path: 'assets/game/hud/hud-bottom-panel.svg',
    textureSize: { width: 1792, height: 100 },
  },
  {
    type: 'svg',
    key: 'hud-hp-panel',
    path: 'assets/game/hud/hud-hp-panel.svg',
    textureSize: { width: 300, height: 80 },
  },
  {
    type: 'svg',
    key: 'hud-players-panel',
    path: 'assets/game/hud/hud-players-panel.svg',
    textureSize: { width: 220, height: 60 },
  },
  {
    type: 'svg',
    key: 'hud-viewer-eye',
    path: 'assets/game/hud/viewer-eye.svg',
  ...
  ...[
    ...
    key,
    path: [
      `assets/game/sounds/effects/${file}`,
      `assets/game/sounds/effects/${file.replace(/\.ogg$/, '.mp3')}`,
    ],
  })),
  ...[
    ...
    type: 'audio' as const,
    key,
    path: `assets/game/sounds/effects/${file}`,
  })),
  ...[
    ...
    type: 'audio' as const,
    key,
    path: `assets/game/sounds/music/${file}`,
  })),
];

export const TANK_TEMPLATE_PATHS = {
  body: '/assets/game/tanks/tank_body_template.svg',
  turret: '/assets/game/tanks/tank_pistol_template.svg',
  hurtBody: '/assets/game/tanks/tank_body_hurt_template.svg',
  hurtTurret: '/assets/game/tanks/tank_pistol_hurt_template.svg',
  criticalBody: '/assets/game/tanks/tank_body_critical_template.svg',
  criticalTurret: '/assets/game/tanks/tank_pistol_critical_template.svg',
  destroyedBody: '/assets/game/tanks/tank_body_destroyed_template.svg',
  destroyedTurret: '/assets/game/tanks/tank_pistol_destroyed_template.svg',
} as const;

export const TANK_TRACK_TEMPLATE_PATHS = {
  normal0: '/assets/game/tanks/track/tank_tracks_0.svg',
  normal1: '/assets/game/tanks/track/tank_tracks_1.svg',
  normal2: '/assets/game/tanks/track/tank_tracks_2.svg',
  critical0: '/assets/game/tanks/track/tank_tracks_critical_0.svg',
  critical1: '/assets/game/tanks/track/tank_tracks_critical_1.svg',
  critical2: '/assets/game/tanks/track/tank_tracks_critical_2.svg',
} as const;

export const SHIELD_TEMPLATE_PATH = '/assets/game/tanks/tank_shield_template.svg';

export const WEAPON_OVERLAY_TEMPLATE_PATHS = {
  triple_shot: '/assets/game/weapons/triple_shot_overlay_template.svg',
  shotgun: '/assets/game/weapons/shotgun_overlay_template.svg',
  grenade: '/assets/game/weapons/grenade_overlay_template.svg',
  laser: '/assets/game/weapons/laser_overlay_template.svg',
} as const;
