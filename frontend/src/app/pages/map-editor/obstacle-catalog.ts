import { ObstacleAssetId, ObstacleType } from '@game/contracts/game-state.types';
...
const bush = (assetId: ObstacleAssetId, name: string): ObstacleCatalogItem => ({
  ...
  type: 'bush',
  assetId,
  previewPath: `assets/game/obstacle/bush/${assetId}.svg`,
  defaultWidth: 64,
  defaultHeight: 64,
  minWidth: 16,
  minHeight: 16,
...
const decoration = (assetId: ObstacleAssetId, name: string): ObstacleCatalogItem => ({
  ...
  type: 'decoration',
  assetId,
  previewPath: `assets/game/obstacle/decoration/${assetId}.svg`,
  defaultWidth: 64,
  defaultHeight: 64,
  minWidth: 12,
  minHeight: 12,
...
export const OBSTACLE_CATALOG: readonly ObstacleCatalogItem[] = [
  ...
  decoration('decoration_14_vine_swirl', 'Vine Swirl'),
  {
    ...
    previewPath: 'assets/game/obstacle/wood_barricade_1.svg',
    defaultWidth: 96,
    defaultHeight: 48,
    minWidth: 16,
    minHeight: 16,
  },
  {
    ...
    type: 'rock',
    assetId: 'rock_block',
    previewPath: 'assets/game/obstacle/rock_block_1.svg',
    defaultWidth: 64,
    defaultHeight: 64,
    minWidth: 16,
    minHeight: 16,
  },
  {
    ...
    previewPath: 'assets/game/obstacle/steel_block_01.png',
    defaultWidth: 64,
    defaultHeight: 64,
    minWidth: 16,
    minHeight: 16,
  },
  {
    ...
    previewPath: 'assets/game/obstacle/mirror_panel_01.svg',
    defaultWidth: 140,
    defaultHeight: 18,
    minWidth: 12,
    minHeight: 12,
