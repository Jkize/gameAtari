...
export const OBSTACLE_DEFINITIONS = {
  bush: { hp: 34, destructible: true, assetId: 'bush_01_rounded_dense' },
  decoration: { hp: 9999, destructible: false, assetId: 'decoration_01_spiky_organic' },
  wood: { hp: 68, destructible: true, assetId: 'wood_barricade' },
  rock: { hp: 102, destructible: true, assetId: 'rock_block' },
  steel: { hp: 9999, destructible: false, assetId: 'steel_block_01' },
  mirror: { hp: 9999, destructible: false, assetId: 'mirror_panel_01' },
